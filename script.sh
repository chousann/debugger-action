...
echo To connect to this session copy-n-paste the following into a terminal: >> mail.txt
...
echo After connecting you can run 'touch /tmp/keepalive' to disable the 15m timeout >> mail.txt
